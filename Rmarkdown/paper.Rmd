...
author: "Benjamin F. Trueman\\* and Graham A. Gagnon"
...
<!-- 1. add a linear model for site to the Ti GAM (currently there in only alpha) -->
...
knitr::include_graphics(here("R/figures/figure-simulation.png"))
```
...
knitr::include_graphics(here("R/figures/figure-censored-response.png"))
```
...
knitr::include_graphics(here("R/figures/figure-censored-predictor.png"))
```
...
knitr::include_graphics(here("R/figures/figure-correlation-matrix.png"))
```
...
knitr::include_graphics(here("R/figures/figure-ppca.png"))
```
